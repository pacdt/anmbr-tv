...
public abstract interface AnmApi {
    ...
    @retrofit2.http.GET(value = "animes/{slug}.json")
    @org.jetbrains.annotations.Nullable
    public abstract java.lang.Object getAnimeDetails(@retrofit2.http.Path(value = "slug")
    ...
    @retrofit2.http.GET(value = "genres/{genre}.json")
    @org.jetbrains.annotations.Nullable
    public abstract java.lang.Object getAnimesByGenre(@retrofit2.http.Path(value = "genre")
    @org.jetbrains.annotations.NotNull
    java.lang.String genre, @org.jetbrains.annotations.NotNull
    kotlin.coroutines.Continuation<? super com.anmfire.tv.data.model.GenreResponse> $completion);
    
    @retrofit2.http.GET(value = "genres/list.json")
    @org.jetbrains.annotations.Nullable
